...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" integrity="sha384-XZ1GwoX3qzNx5k5vFoz38nD8NpNtllFr1NLev1TKpwGCZtMOXPUICoGQ2QaOy+E0" crossorigin="anonymous">
        ...
        <div class="header-container">
            <header class="header navbar navbar-expand-sm">
                ...
                <div class="nav-logo align-self-center">
                    <a class="navbar-brand" href="{{url('home')}}"><img alt="logo" src="{{ asset('images/syslogo.png') }}">
                ...
                <nav id="topbar">
                    ...
                    <ul class="list-unstyled menu-categories" id="topAccordion">
                        <li class="menu single-menu ">
                            <a href="{{url('cajon')}}" data-toggle="collapse" aria-expanded="true"
